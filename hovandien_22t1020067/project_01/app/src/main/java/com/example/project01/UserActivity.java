...
//Khởi tạo các biến điều khiển tương ứng trong layout
        ...
        m_btnUpdate.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                String fullname = m_edtNewFullName.getText().toString();
                ...
                if (email.isEmpty() && pass.isEmpty() && fullname.isEmpty()) {
                    Toast.makeText(getApplicationContext(), "Email hoặc Password hoặc fullname phải có để cập nhật", Toast.LENGTH_SHORT).show();
                    return;
                }
