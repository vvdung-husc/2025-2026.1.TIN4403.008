...
//    public static final String URL_USER_REGISTER = "https://dev.husc.edu.vn/tin4403/api/register";
    ...
    public static final String URL_LOGIN = "http://localhost:4380/login";
    public static final String URL_USER_INFO = "http://localhost:4380/userinfo";
    public static final String URL_USER_UPDATE = "http://localhost:4380/userupdate";
    public static final String URL_USER_REGISTER = "http://localhost:4380/register";
