...
public class ApiClient {
   ...
   public static final String URL_LOGIN = "http://192.168.1.4:4380/login";
   public static final String URL_USER_INFO = "http://192.168.1.4:4380/userinfo";
   public static final String URL_USER_UPDATE = "http://192.168.1.4:4380/userupdate";
   public static final String URL_USER_REGISTER = "http://192.168.1.4:4380/register";
    ...
    // PUT JSON
    // ==========================
    public static ApiResult httpPut(String url, String json, Map<String, String> headers) {
        MediaType JSON = MediaType.parse("application/json; charset=utf-8");
    ...
    // DELETE
    // ==========================
    public static ApiResult httpDelete(String url, Map<String, String> headers) {
